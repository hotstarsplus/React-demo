 ...
 * 表单视图的Action 类
 */
export class QuantityTapyFormUiAction {
    /**
     * 表单数据
     */
    public formData: QuantityTapy;
    /**
     * 当前表单的api接口
     */
    private props: IQuantityTapyFormProps;
    /**
     * 表单验证是否通过
     */
     ...
     * @param values 
     */
    private Validate(values: QuantityTapy): string | undefined {
        return undefined;
    }
}
