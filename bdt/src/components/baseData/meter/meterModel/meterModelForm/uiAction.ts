 ...
 * 表单视图的Action 类
 */
export class MeterModelFormUiAction {
    /**
     * 表单数据
     */
    public formData: MeterModel;
    /**
     * 当前表单的api接口
     */
    private props: IMeterModelFormProps;
    /**
     * 表单验证是否通过
     */
     ...
     * 构造表单action实例
     * 
     * @param {IMeterModelFormProps} props 表单的props
     */
    ...
    private validates(value: MeterModel): string | undefined {
        return undefined;
    }
}