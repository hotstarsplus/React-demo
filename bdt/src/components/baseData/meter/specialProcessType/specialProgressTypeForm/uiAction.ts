 ...
 * 表单视图Action类
 */
export class SpecialProcessTypeFormUiAction {

    /**
     * 表单数据
     */
    private formData: SpecialProcessType;

    /**
     * 当前表单的api接口
     */
    private props: ISpecialProcessTypeFormProps;
     ...
     * @param values 
     */
    private validates(values: SpecialProcessType): string | undefined {
        return undefined;
    }
