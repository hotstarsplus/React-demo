 ...
 * 业务类别表单视图的Action 类
 */
export class BusinessTypeFormUiAction {
    /**
     * 表单数据
     */
    private formData: BusinessType ;

    /**
     * 当前表单的api接口
     */
    private props: IBusinessTypeFormProps;
     ...
     * 构造表单action实例
     * 
     * @param {IBusinessTypeFormProps} props 表单的props
     */
    ...
    public validate(): {
        ...
        // const BusinessTypes:BusinessType = new BusinessType();
        return {
            formData: this.formData,
            isValidated: this.isValidated,
        }
