 ...
 * 供水所表单视图的action
 */
export class WaterStationFormUiAction{

    /**
     *  当前表单的api接口
     */
    private props:IWaterStationFormProps;

    /**
     * 表单数据
     */
    private formData:WaterStation;
    ...
    private validateServer(values:any){
        ...
        if (!this.props.GlobalWaterStationStore) {
     ...
     */
     @action.bound
     private Validate(model: WaterStation): string | undefined {
         return undefined;
     }
