 ...
 * 表单视图的Action 类
 */
export class WaterRateItemTypeItemFormUiAction {

    /**
     * 表单数据
     */
    public formData: WaterRateItemType;

    /**
     * 当前表单的api接口
     */
    private props: IWaterRateItemTypeItemFormProps;
     ...
     * 构造表单action实例
     * 
     * @param {IWaterRateItemTypeItemFormProps} props 表单的props
     */
